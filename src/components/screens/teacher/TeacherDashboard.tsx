// src/components/screens/teacher/TeacherDashboard.tsx
...
import { TeacherCourseCard } from '@/components/shared/CourseCard';
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            ...
            <Text style={[styles.sectionLabel, { color: colors.textSecondary }]}>My Classes</Text>
          </View>
        }
        ListEmptyComponent={
          <View style={styles.empty}>
            <Text style={styles.emptyIcon}>🏫</Text>
            <Text style={[styles.emptyTitle, { color: colors.textPrimary }]}>No Classes Assigned</Text>
            <Text style={[styles.emptyBody, { color: colors.textSecondary }]}>
              You haven't been assigned to any classes yet. Contact the school administrator.
            </Text>
          </View>
        }
        renderItem={({ item }) => (
